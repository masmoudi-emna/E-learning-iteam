...
$cours = mysqli_query($conn, "
    SELECT c.id, c.titre, c.description, c.image, p.name AS enseignant 
    FROM cours c 
            ...
            <?php while ($cour = mysqli_fetch_assoc($cours)): ?>
                <div class="col">
                    <div class="cours-card">
                        ...
                        <div class="cours-footer d-flex justify-content-between">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="enseignant_id" class="form-select" required>
                                        ...
                                        <?php while ($enseignant = mysqli_fetch_assoc($enseignants)): ?>
